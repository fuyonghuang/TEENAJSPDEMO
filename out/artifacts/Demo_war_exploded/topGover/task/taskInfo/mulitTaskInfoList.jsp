...
<%
    ...
    if (action.equalsIgnoreCase("query")) {
        ...
        querySqlStr = QUERY_TASKINFO + "  and info_status = ? and task_category = 1";
...
<form method="post" action="mulitTaskInfoList.jsp" name="this_form" style="padding:0; margin:0;">
        ...
        <table class="queryTableResultStyle">
            ...
            <tr class="queryTableResultTitleStyle">
                ...
                <td width="10%" onclick="sortByKey('release_persion')"> <span
                        id="release_persion">创建人</span></td>
                <td width="10%" onclick="sortByKey('release_time')"><span
                        id="release_time">创建时间</span>
                </td>
            ...
            <tr>
                ...
                <td><%=record.getString("create_user")%>&nbsp;</td>
                <td><%=record.getString("create_time")%>&nbsp;</td>
                <%
                ...
                %>
                <td>
                    <a href="/topGover/task/taskInfo/detail/mulitTaskDetails.jsp?taskId=<%=record.getString("task_id")%>">详情</a>&nbsp;
                </td>
            </tr>
            <%}%>
